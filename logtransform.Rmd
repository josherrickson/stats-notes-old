...
> The predicted average salary decreases by $`r abs(round(log(1.2)*mod2$coef["log(Hits)"], 2))` when the number of hits increases by 20\% (when all other predictors are constant).
